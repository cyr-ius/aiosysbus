...
class Locations:
    ...
    async def get_locations_domain(self, conf: dict[str, Any]) -> dict[str, Any] | None:
        """Get domain location."""
    ...
    async def add_locations(self, conf: dict[str, Any] | None) -> dict[str, Any] | None:
        """Add location."""
        return await self._access.post("Locations", "addLocation", conf)

    async def del_locations(self, conf: dict[str, Any] | None) -> dict[str, Any] | None:
        """Remove location."""
        return await self._access.post("Locations", "removeLocation", conf)

    async def set_locations_section(
        self, conf: dict[str, Any] | None
    ) -> dict[str, Any] | None:
        """Set location."""
        return await self._access.post("Locations", "setSection", conf)

    async def del_locations_section(
        self, conf: dict[str, Any] | None
    ) -> dict[str, Any] | None:
        """Remove section."""
        return await self._access.post("Locations", "removeSection", conf)

    async def get_locations_composition(
        self, conf: dict[str, Any] | None = None
    ) -> dict[str, Any] | None:
