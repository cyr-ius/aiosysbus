...
class Wifi:
    ...
    async def async_start_wifi_pairing(self) -> dict[str, Any] | None:
        """Wifi start pairing."""
        return await self._auth.post("NMC.Wifi", "startPairing")

    async def async_stop_wifi_pairing(self) -> dict[str, Any] | None:
        """Wifi stop pairing."""
        return await self._auth.post("NMC.Wifi", "stopPairing")

    async def async_start_wifi_autochannel(self) -> dict[str, Any] | None:
