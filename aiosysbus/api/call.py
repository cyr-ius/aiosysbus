...
class Call:
    ...
    async def async_get_dect_pin(self) -> dict[str, Any] | None:
        """Get Pin code for DECT."""
        return await self._auth.post("DECT", "getPIN")

    async def async_set_dect_pin(
        self, conf: dict[str, Any] | None
    ) -> dict[str, Any] | None:
        """Set Pin code for DECT."""
        return await self._auth.post("DECT", "setPIN", conf)

    async def async_get_dect_version(self) -> dict[str, Any] | None:
        """Get DECT version."""
        return await self._auth.post("DECT", "getVersion")

    async def async_get_dect_standardversion(self) -> dict[str, Any] | None:
        """Get standard version."""
        return await self._auth.post("DECT", "getStandardVersion")

    async def async_get_dect_rfpi(self) -> dict[str, Any] | None:
        """Get RFPI."""
...
class Phonebook:
    ...
    async def async_get_contacts(self) -> dict[str, Any] | None:
        """Get all contacts."""
        return await self._auth.post("Phonebook", "getAllContacts")

    async def async_get_count(self) -> dict[str, Any] | None:
        """Count contacts."""
        return await self._auth.post("Phonebook", "getNumberOfContacts")

    async def async_get_maxnumber(self) -> dict[str, Any] | None:
