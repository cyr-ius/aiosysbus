...
class Schedule:
    ...
    async def async_get_schedule(self, conf: dict[str, Any] | None = None) -> dict[str, Any] | None:
    ...
    async def async_add_schedule(self, conf: dict[str, Any] | None) -> dict[str, Any] | None:
        """Add schedule.
    ...
    async def async_enable_schedule(self, conf: dict[str, Any] | None) -> dict[str, Any] | None:
        """Get schedule information."""
        return await self._access.post("Scheduler", "enableSchedule", conf)

    async def async_set_schedule(self, conf: dict[str, Any] | None) -> dict[str, Any] | None:
        """Get schedule information."""
        return await self._access.post("Scheduler", "overrideSchedule", conf)

    async def async_set_state(self, conf: dict[str, Any] | None) -> dict[str, Any] | None:
        """Get schedule information."""
        return await self._access.post("Scheduler", "overrideState", conf)

    async def async_remove_schedule(self, conf: dict[str, Any] | None) -> dict[str, Any] | None:
        """Get schedule information."""
